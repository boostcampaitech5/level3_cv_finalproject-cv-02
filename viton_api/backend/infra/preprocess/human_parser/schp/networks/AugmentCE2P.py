...
def initialize_pretrained_model(model, settings, pretrained='./pretrained/resnet101-imagenet.pth'):
...
def resnet101(num_classes=20, pretrained='./pretrained/resnet101-imagenet.pth'):
