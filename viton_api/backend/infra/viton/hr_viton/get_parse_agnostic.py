...
def get_im_parse_agnostic(im_parse, pose_data, w=768, h=1024):
    ...
    # # parse-agnostic visualize
    # np_agnostic = np.array(agnostic)
    # np_agnostic[np_agnostic == 2] = 151
    # np_agnostic[np_agnostic == 9] = 178
    # np_agnostic[np_agnostic == 13] = 191
    # np_agnostic[np_agnostic == 14] = 221
    # np_agnostic[np_agnostic == 15] = 246
    # agnostic = Image.fromarray(np_agnostic)
